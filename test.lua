...
local Hub = loadstring(game:HttpGet("https://raw.githubusercontent.com/NoxLoveYa/RobloxProjects/refs/heads/main/Gui%20roblox.lua"))()
...
local toggleFrame, _ = Hub.Toggle(testPage, "Auto Train", false, function(v) autoTrainEnabled = v end)
sec.Add(toggleFrame)

local toggleFrame2, _ = Hub.Toggle(testPage, "Auto Cast", false, function(v) autoCastEnabled = v end)
...
local function autoTrain()
    for _, gui in ipairs(playerGui:QueryDescendants("TextButton")) do
        ...
        if guiFullName ~= "Players." .. localplayer.Name .. ".PlayerGui.5.1.1.1.1.3" then continue end
...
local function autoCast()
    ...
    if not castGui then return end
